...
export default function Footer() {
  return (
    <footer className="border-t border-[#12310e] bg-[#051001] pt-16 pb-8 text-gray-300">
        ...
        <div className="w-full max-w-[1200px] flex flex-col gap-12">
          ...
          <div className="grid grid-cols-1 gap-10 md:grid-cols-2 lg:grid-cols-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">About Us</Link>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">Blog</Link>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">FAQ</Link>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">Terms & Conditions</Link>
            </div>

            {/* Categories */}
            <div className="flex flex-col gap-4">
              <h4 className="text-white font-bold">Products</h4>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">Ready Terrariums</Link>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">Moss Walls</Link>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">DIY Kits</Link>
              <Link href="#" className="text-gray-300 text-sm hover:text-green-500 transition-colors">Indoor Plants</Link>
            </div>
          ...
          <div className="flex flex-col items-center justify-between gap-4 border-t border-[#12310e] pt-8 md:flex-row text-center">
            <p className="text-gray-300 text-sm">© 1403 All rights reserved.</p>
