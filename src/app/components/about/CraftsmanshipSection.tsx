        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-gray-600 leading-8 mb-6 text-justify">
              در <strong className="text-gray-800">طلای سبز</strong>، ما فقط یک
              ...
              <br />
              <br />
              تمام محصولات طلای سبز با رعایت استانداردهای بهداشتی، به‌صورت
            ...
            <ul className="space-y-4 text-gray-700">
              <li>✓ تولید مستقیم از باغ‌های اختصاصی طلای سبز</li>
